...
//        dsNuocUong.add(new Menu_Item("Nước uống 1","20 000 đ",R.drawable.nuoc_9));
    ...
    public static void addToCart(Drink_Item drink_item){
        ...
        while (i< com.example.vcafe.order.OrderActivity.dsOrder.size()){
        ...
        if(i== com.example.vcafe.order.OrderActivity.dsOrder.size()){
            com.example.vcafe.order.OrderActivity.dsOrder.add(drink_oder_item);
        }
        updateCard();
